...
**Status**: v1 through v1.3 are done and live at https://ssvito.github.io/ice-breaker/ - pixel-string sprites via a generator, virtual-resolution renderer, glitch-scatter kills, a terminal console that reads out towers, enemies and the wave that is coming, and a ten-wave run with pause, 2x and an early-call bonus. Specs in [Sprite Spec](./Design/Sprite%20Spec.md), [Tower Panel](./Design/Tower%20Panel.md) and [Run Structure](./Design/Run%20Structure.md), build order in [Roadmap](./Roadmap.md).
