...
O Overclock na simulação continua fora, então tudo acima segue sendo piso e não medida. **Isso deixou de valer em 2026-09-12** - ver a última entrada desta página: o harness sabe disparar Overclock, e a suposição de que ele só podia somar estava errada.
...
E ainda em **2026-09-12**, o passo 4 do v1.9 mediu o Overclock e **derrubou o caveat que esta página vinha repetindo**. Não é que o harness estivesse subestimando as linhas: disparar Overclock no cooldown *piora* umas e salva outras. No RECURSION 02 o `veteran` cai de 4 de core e primeiro leak em 0.96x para 1 de core e primeiro leak em 0.35x; o `rush` sai de core arrombado para vitória com 3, e de morrer em 0.82x para morrer em 1.17x. Mesmo layout, mesma compra: 460 de 545 nos dois.

O motivo é aritmética de duty cycle: 4 segundos a 2,5x de cadência comprados com 3 segundos sem atirar são +43% de média com um buraco dentro. **Média é o que importa quando se está atrás; consistência é o que importa quando se está na frente.** E na run humana gravada, oitenta apertos por cima das decisões dela mudam o resultado em nada e tiram 1,8 segundo - o que torna "não gosto de usar Overclock" uma leitura correta de um board em que o jogador está ganhando, e não um buraco no jogo dele.
